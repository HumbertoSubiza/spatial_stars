...
---
  ...
  3. Com os dois objetos no mesmo sistema de referencia, será cortada a imagem nas bandas 1 a 3 (BGR), usando o polígono do municipio. O corte será feito usando  paréntesis reto, como vimos no documento 1 desta série.
...
Otra función que puede ser útil es _dplyr::slice()_, que también permite extraer por ejemplo, bandas o valores determinados de cada dimensão.
