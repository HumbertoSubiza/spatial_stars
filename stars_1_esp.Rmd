...
La biblioteca permite trabajar con dados en mallas regular o irregulamente espaciadas, así como con proyecciones cartesians o curvilíneas.

Para simplificar vamos leer um archivo raster de ejemplo que la propia biblioteca incluye. El archivo es uma imagem Landsat 7 ETM, con 6 bandas, azul, verde, rojo (BGR) y 3 más de infrarrojo, em formato Geotiff. La importación hará uso de la biblioteca GDAL.
...
En el caso específico de la imagen importada la cantidade de células en _x_ es de 349 y en _y_ de 352, comenzando con los valores de 288776 para el eje _x_ y de 9120761 para _y_. El sistema de referencia es UTM zona 25S y los intervalos entre cada célula (delta) de 28,5 m y -28,5 m respectivamente. La imagen corresponde a um raster (point = F) del área de Recife, Brasil.
...
Para valores al centro de la célula, el valor absoluto del delta debe ser aumentado em $14.3$.
...
plot(olinda["gid"], axes = T) # visualización
```
