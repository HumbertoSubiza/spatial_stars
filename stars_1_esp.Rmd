...
Asi, el menor archivo raster tiene dos dimensiones espaciales representando la localización por ejemplo y un atributo que es el tipo de dato de la capa (layer). En la figura a seguir se representa un arreglo cúbico de cinco dimensiones.
...
Para simplificar vamos leer un archivo raster de ejemplo que la propia biblioteca **stars** incluye. El archivo es una imagem Landsat 7 ETM, con 6 bandas, azul, verde, rojo (BGR) y 3 más de infrarrojo, emn formato Geotiff. La importación hará uso de la biblioteca GDAL.
...
### 4. Lectura de archivo vectorial tipo ESRI por la biblioteca **sf**.
