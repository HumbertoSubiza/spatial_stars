...
La biblioteca maneja tambien datos vectoriales, del tipo punto o poligono, siendo éstos bi-dimensioales.
...
Los objetos del tipo vectorial pueden importarse a través de la biblioteca **sf** o pueden crearse usando funciones de la propia biblioteca **stars**. Primero vamos importar un archivo de la misma área de la imagen anterior, que representa los límites del município de Olinda, Brasil.
...
El objeto es del tipo **stars**, con apenas 1 dimensión y 5 atributos, siendo éstos presentados en resumen estatístico, dependiendo del tipo de atributo. La visualización es semejante a la anterior, pudiendo colocar en el comando _plot()_, el nombre o el número del atributo deseado.
