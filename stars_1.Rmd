...
Esta nueva biblioteca crea objetos de la clase **stars** 
Datacubes array o arreglos con dimensiones y atributos que puedes ser de espacio o tiempo.
Asi un archivo raster minimo tiene dos dimensiones y un atributo que es el nombre de la camada, pero también puede tener varias dimensiones, como en la figura a seguir que posee 5.

![Cinco dimensiones: longitud, latitud, banda, tiempo y sensor](https://raw.githubusercontent.com/r-spatial/stars/master/images/cube2.png)


Los objetos creados pertenecen a una nueva clase **stars** que tiene los siguientes métodos disponibles:
